...
function Card() {
  ...
  useEffect(() => {
    axios
      .get("https://intern-fe-assign-backend.herokuapp.com/jobs")
      .then((res) => {
        console.log(res);
        setJobs(res.data);
      })
          ...
          {jobs
            .filter((value) => {
              if (search === "") {
                ...
                value.jobTitle.toLowerCase().includes(search.toLowerCase())
              ) {
                return value;
              } else if (
            ...
            .filter((value2) => {
              if (check) return value2.isFullTime === true;
              else return value2;
            })
                ...
                <div className='column'>
                  <div className='Rect'>
                    <div className='cardContent'>
                      ...
                      <h5 className='time'>
                        <Moment fromNow>{job.datePosted}</Moment> .{" "}
                        {job.isFullTime == true ? "Full Time" : "Part Time"}
                      </h5>
